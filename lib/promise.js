...
module.exports = function (options) {
    ...
    options = options || {};
    var throwUncaughtError = !!options.throwUncaughtError;
...
//        }
        if (isWellPromise(promiseOrValue)) return promiseOrValue;
    ...
    function newPromise(resolver, cancel) {
        ...
        promise.__proto__ = UnresolvedPromise;
...
//        if (throwUncaughtError && state === states.rejected && utils.isError(value)) throw value;
        var promise = function () {
        };
        promise.__proto__ = ResolvedPromise;
        promise.state = state;
        promise.value = value;
        return promise;
    }
    ...
    function extend(api) {
        ...
        Object.keys(api).forEach(function (key) {
            defineProperty(ResolvedPromise, key, d(api[key]));
            defineProperty(UnresolvedPromise, key, d(api[key]));
        });
        return this;
    }

    var ResolvedPromise, UnresolvedPromise, doneFn;

    ResolvedPromise = Object.create(Function.prototype, {
        __well__: d('', true),
        resolved: d(true),
    ...
    UnresolvedPromise = Object.create(Function.prototype, {
        __well__: d('', true),
